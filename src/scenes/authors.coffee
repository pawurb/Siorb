Crafty.scene 'Authors', ->
  ...
  Crafty.e('ButtonWithLink').addLink('http://www.github.com/pawurb', 'autPabloLogo.png', 'GitHub').at(textX + 225, topY + 40)

  Crafty.e('Base, aut_cebula_text').at(textX, topY + yOffset * 2)
  Crafty.e('ButtonWithLink').addLink('http://www.digart.pl/' , 'autCebulaLogo.png', 'DigArt').at(textX + 160, topY + 75)
